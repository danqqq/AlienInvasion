...
class Scoreboard:
    ...
    def __init__(self, ai_game):
        ...
        """Points font settings"""
        self.text_color = (30, 30, 30)
        self.font = pygame.font.SysFont(None, 48)
        """Initial scoring information"""
        self.spaceships = None
        self.prep_score()
    ...
    def prep_score(self):
        ...
        score_str = '{:,}'.format(rounded_score) + ' - Score'
    ...
    def prep_high_score(self):
        ...
        high_score_str = '{:,}'.format(high_score) + ' - HS'
    ...
    def prep_level(self):
        level_str = str(self.stats.level) + ' - Level'
    ...
    def prep_spaceships(self):
        ...
        for spaceships_number in range(self.stats.spaceships_left):
            spaceship = Spaceship(self.ai_game)
            spaceship.rect.x = 10 + spaceships_number * spaceship.rect.width
            spaceship.rect.y = 10
